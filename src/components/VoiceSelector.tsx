  ...
  const fetchVoices = async () => {
    try {
      ...
      const fallbackVoices: Voice[] = [
        ...
        { voice_id: 'MF3mGyEYCl7XYWbV9V6O', name: 'Cora', category: 'Female', description: 'Bright, friendly, youthful', preview_url: '', labels: { gender: 'female', accent: 'american' }, suggestedPersonality: ['Playful','Caring','Bubbly'], characteristics: { warmth: 92, energy: 84, clarity: 94, depth: 80 } },
        { voice_id: 'onwK4e9ZLuTAKqWW03F9', name: 'Domi', category: 'Female', description: 'Sultry, intimate, romantic', preview_url: '', labels: { gender: 'female', accent: 'american' }, suggestedPersonality: ['Romantic','Alluring','Confident'], characteristics: { warmth: 95, energy: 68, clarity: 92, depth: 90 } },
        { voice_id: 'ZQe5CZNOzWyzPSCn5a3a', name: 'Ana', category: 'Female', description: 'Soft Spanish accent, tender tone', preview_url: '', labels: { gender: 'female', accent: 'spanish' }, suggestedPersonality: ['Gentle','Romantic','Warm'], characteristics: { warmth: 93, energy: 70, clarity: 91, depth: 85 } },
        { voice_id: 'pNInz6obpgDQGcFmaJgB', name: 'Olivia', category: 'Female', description: 'Crisp, elegant, assured', preview_url: '', labels: { gender: 'female', accent: 'british' }, suggestedPersonality: ['Intellectual','Direct','Elegant'], characteristics: { warmth: 86, energy: 72, clarity: 97, depth: 88 } },
      ];
